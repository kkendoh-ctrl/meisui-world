...
const historicalEvents = {
    ...
    // Step 16: 2061-2070
    2061: {text: '東京湾海上都市 始動！ 湾を横断する線形メガストラクチャーが浮かぶ', emoji: '🏙️'},
    // Step 17: 2071-2080
    2071: {text: '海底トンネルで千葉と神奈川が直結！ 浦安↔新浦安ロープウェイも開通', emoji: '🚇'},
    // Step 18: 2081-2090
    2081: {text: '海上都市 第2期拡張 — 居住人口5万人を突破', emoji: '🌆'},
    // Step 19: 2091-2100
...
const levelThresholds = [
    { min: 0, max: 14, title: "むらがさかえてきた", emoji: "🌾" },    // 1889-1950: 漁村の発展期
    { min: 15, max: 29, title: "うみべのまちへ", emoji: "🏗️" },      // 1951-2000: 埋立と変貌の時代
    { min: 30, max: 44, title: "にぎわうみなとまち", emoji: "🏙️" },  // 2001-2050: 現代の活気ある街
    { min: 45, max: 59, title: "みらいとしうらやす", emoji: "🚀" },   // 2051-2090: 未来都市へ
    { min: 57, max: 63, title: "でんせつのまち", emoji: "✨" },       // 2091-2100: 究極の完成
];
